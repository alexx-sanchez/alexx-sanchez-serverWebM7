<?php 
    ...
    if (isset($_GET['nom'])) {
        ...
        $stmt = $db->prepare("SELECT * FROM noticies WHERE LOWER(not_titular) = LOWER(:titular)");
        ...
        echo '<form action="cercaPerTitular.php"><input type="submit" value="Torna a la pagina de cerca"></form>';
        
    } else {
        echo '<form action="cercaPerTitular.php" method="get">
                <label for="nom">Titular exacte per cercar: </label>
